...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'ShopAI')); ?></title>
                    ...
                    <div class="flex justify-between h-20 items-center">
                        ...
                        <div class="flex items-center space-x-12">
                            ...
                            <div class="shrink-0 flex items-center">
                                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 text-2xl font-black text-[#111827] tracking-tight">
                            ...
                            <div class="hidden md:flex space-x-8">
                                <a href="<?php echo e(route('home')); ?>" class="text-sm font-semibold text-gray-900 hover:text-blue-600 transition">Home</a>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(route('orders.index')); ?>" class="text-sm font-semibold text-gray-600 hover:text-blue-600 transition">My Orders</a>
                        ...
                        <div class="flex items-center space-x-4">
                            <!-- Cart -->
                            <a href="<?php echo e(route('cart.index')); ?>" class="text-gray-600 hover:text-blue-600 transition relative bg-gray-50 p-2 rounded-md">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" class="absolute right-0 mt-3 w-48 bg-white rounded-lg shadow-lg py-2 border border-gray-100 z-50 origin-top-right">
                                        ...
                                        <a href="<?php echo e(route('orders.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600 transition">My Orders</a>
                                        <form method="POST" action="<?php echo e(route('logout')); ?>">
                                            <?php echo csrf_field(); ?>
                                            <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); this.closest('form').submit();" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600 transition">
                                                Log Out
                                            </a>
                                        </form>
                                    </div>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="bg-gray-50 p-2 rounded-md hover:bg-blue-50 hover:text-blue-600 transition text-gray-600">
            ...
            <footer class="bg-[#111827] text-gray-300 pt-16 pb-8">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                        ...
                        <div class="pr-8">
                            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 text-xl font-black text-white tracking-tight mb-6">
...
<?php /**PATH C:\Users\hassa\OneDrive\Desktop\ai_ecommerce_store_chatbot\resources\views/layouts/storefront.blade.php ENDPATH**/ ?>